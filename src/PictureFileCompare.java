...
public class PictureFileCompare {
	...
	static Scanner  consolescan = new Scanner(System.in); 
    ...
    public static void main(String[] args) throws IOException
    {
    	...
    	while (mainLoop)
    	{
	    	...
	    	//Set Up Log File
	    	//Check to see if log exists, if it uses that file, if it does goes to the next number
	    	for (int c = 1; c < 100; c++)
	        {
	    		//starts stepping though files until it finds one that does not exist
	        ...
	        //Restart Program, Open Scan, Ask to restart, Yes or No
	        System.out.print("Restart Program? (Yes/No): ");
	        consolescan = new Scanner(System.in); // open a new Scanner name it "scan"
	        tempString = consolescan.nextLine(); // set [object being acted on] = [what was input into scanner]
	        
	        //Check what was inputed
	        if (tempString.equalsIgnoreCase("yes") || tempString.equalsIgnoreCase("y")) {
